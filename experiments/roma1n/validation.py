...
def main():
    ...
    fashoin_items_path = os.path.join(os.environ['PROJECT_DIR'], 'data', 'lamoda', 'validation', 'fashion_items')
    validation_dataset_path = os.path.join(os.environ['PROJECT_DIR'], 'data', 'lamoda', 'validation')
    result_path = os.path.join(os.environ['PROJECT_DIR'], 'data', 'lamoda', 'validation', 'result.json')
